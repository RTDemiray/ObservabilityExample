...
public class PaymentService
{
    ...
    public async Task<(bool isSuccess, string? failMessage)> CreatePaymentProccessAsync(PaymentCreateRequestDto request)
    {
        var response = await _client.PostAsJsonAsync("api/PaymentProccess", request);
